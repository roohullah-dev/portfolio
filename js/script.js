...
ScrollReveal().reveal(
  ".home-info, .section-title,  .portfolio-container .top-side",
  {
    origin: "top",
  }
);
ScrollReveal().reveal(
  ".home-image, .contact .container, .service .container,  .portfolio-container .bottom-side ",
  {
    origin: "bottom",
  }
);

ScrollReveal().reveal(".nav, .portfolio-container .left-side, ", {
  origin: "left",
});
ScrollReveal().reveal(".portfolio-container .right-side", {
  origin: "right",
});
